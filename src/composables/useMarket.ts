...
export type DesktopView = 'recommend' | 'market' | 'all-market' | 'events' | 'strategy' | 'opinion' | 'backtest' | 'data'
export type MobileTab = 'recommend' | 'market' | 'watchlist' | 'all' | 'events' | 'strategy' | 'opinion' | 'backtest' | 'trade' | 'data'
